...
import {
  ...
  GraduationCap, BookOpen, MapPin, Globe
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full">
      <div className="container mx-auto p-6 space-y-8 max-w-5xl pt-24">
            ...
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="ivy-font flex items-center gap-2">
                  ...
                  Student Profile Verification Status
                </CardTitle>
                <CardDescription className="ivy-font">
                  Student profile verification and compliance
                </CardDescription>
              </div>
              {hasCompletedKYC ? (
                <Badge className="bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20">
            ...
            {hasCompletedKYC ? (
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground ivy-font">
                  Your student profile has been verified and you have full access to all features.
                </p>
                <Button
              ...
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground ivy-font">
                  Complete your student profile to unlock full access to GradPilot features including AI counselling, lead scoring, and automated follow-ups.
                </p>
                <Button
                  onClick={() => router.push("/onboarding")}
        ...
        {hasCompletedKYC && studentProfile && (
          <Card className="border-border/40 backdrop-blur-sm bg-card/50">
            <CardHeader>
              <CardTitle className="ivy-font flex items-center gap-2">
              ...
              <CardDescription className="ivy-font">
                Your verified student information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground ivy-font">Education Level</p>
                    <p className="font-medium ivy-font">{studentProfile.educationLevel || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground ivy-font">Field of Study</p>
                    <p className="font-medium ivy-font">{studentProfile.fieldOfStudy || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground ivy-font">Institution</p>
                    <p className="font-medium ivy-font">{studentProfile.institution || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground ivy-font">Course Interest</p>
                    <p className="font-medium ivy-font">{studentProfile.courseInterest || 'N/A'}</p>
                  </div>
                </div>
              </div>
              ...
              {studentProfile.verificationStatus && (
                <>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
                    ...
                    {studentProfile.completedAt && (
                      <p className="text-sm text-muted-foreground ivy-font">
                        {new Date(studentProfile.completedAt).toLocaleDateString()}
                      </p>
                    )}
                  </div>
                </>

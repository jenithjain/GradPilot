...
import { 
  ...
  Shield, Github, Chrome, Loader2, GraduationCap, Briefcase
} from "lucide-react";
        ...
        <div className="hidden md:block space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground ivy-font max-w-md">
              Secure access to AI-powered student counselling, lead qualification, and automated follow-up workflows.
            </p>
          </div>
          ...
          <div className="space-y-3 mt-8">
            {[
              { icon: TrendingUp, title: "Lead Qualification", desc: "Score and classify student leads intelligently" },
              { icon: Shield, title: "Authorized Access Only", desc: "Protect sensitive student data and records" },
              { icon: Sparkles, title: "AI Voice Agent", desc: "Autonomous student counselling conversations" }
            ].map((feature, idx) => (
              <div 
                key={idx}
        ...
        <Card className="border-border/40 backdrop-blur-xl bg-card/80 shadow-2xl">
          <CardHeader className="space-y-1 text-center pb-6">
            ...
            <CardDescription className="ivy-font">
              {isLogin 
                ? "Secure authentication required to access counselling dashboard and student data" 
                : "Create an account to access AI-powered student counselling platform"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isLogin && (
                <div className="space-y-2">
                  <Label className="ivy-font">I am a...</Label>
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <GraduationCap className={`w-6 h-6 ${formData.role === 'student' ? 'text-emerald-600 dark:text-emerald-400' : ''}`} />
                      <span className="text-sm font-medium ivy-font">Student</span>
                      <span className="text-xs text-muted-foreground ivy-font text-center">Looking to study abroad</span>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <Briefcase className={`w-6 h-6 ${formData.role === 'counsellor' ? 'text-emerald-600 dark:text-emerald-400' : ''}`} />
                      <span className="text-sm font-medium ivy-font">Counsellor</span>
                      <span className="text-xs text-muted-foreground ivy-font text-center">Education consultant</span>
                    </button>
                  </div>
                </div>
              )}
